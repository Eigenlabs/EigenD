...
#define SCALER_IN_MASK SIG12(SCALER_KEY,SCALER_TONIC,SCALER_BASE,SCALER_SCALE,SCALER_KBEND,SCALER_GBEND,SCALER_KRANGE,SCALER_GRANGE,SCALER_CONTROL,SCALER_OVERRIDE,SCALER_OCTAVE,SCALER_ROCTAVE)
