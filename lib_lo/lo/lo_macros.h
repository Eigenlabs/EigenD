...
#define lo_send_broadcast(targ, path, types...) \
        lo_send_internal_broadcast(targ, __FILE__, __LINE__, path, types, \
                                    LO_MARKER_A, LO_MARKER_B)
...
int lo_send_broadcast(lo_address targ, const char *path, const char *types, ...);
