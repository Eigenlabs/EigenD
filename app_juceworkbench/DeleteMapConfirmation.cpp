...
//==============================================================================
DeleteMapConfirmation::DeleteMapConfirmation ()
{
    ...
    addAndMakeVisible (label = new Label ("new label",
                                          TRANS("This will remove the current key mapping.  The change cannot be reverted with this editor. Do you want to continue ?\n")));
...
//==============================================================================
void DeleteMapConfirmation::paint (Graphics& g)
{
...
void DeleteMapConfirmation::resized()
{
...
void DeleteMapConfirmation::buttonClicked (Button* buttonThatWasClicked)
{
...
<JUCER_COMPONENT documentType="Component" className="DeleteMapConfirmation" componentName=""
  ...
  <LABEL name="new label" id="cf632a1aa060f6f0" memberName="label" virtualName=""
         ...
         edTextCol="ff000000" edBkgCol="0" labelText="This will remove the current key mapping.  The change cannot be reverted with this editor. Do you want to continue ?&#10;"
