...
//==============================================================================
DeleteAgentConfirmation::DeleteAgentConfirmation (String agentName)
{
    ...
    label->setText("Delete agent "+agentName + " ?",dontSendNotification);
    okPressed_=false;
...
DeleteAgentConfirmation::~DeleteAgentConfirmation()
{
...
//==============================================================================
void DeleteAgentConfirmation::paint (Graphics& g)
{
...
void DeleteAgentConfirmation::resized()
{
...
void DeleteAgentConfirmation::buttonClicked (Button* buttonThatWasClicked)
{
...
<JUCER_COMPONENT documentType="Component" className="DeleteAgentConfirmation"
  ...
  <LABEL name="new label" id="cf632a1aa060f6f0" memberName="label" virtualName=""
         ...
         edTextCol="ff000000" edBkgCol="0" labelText=" Delete agent ?"
