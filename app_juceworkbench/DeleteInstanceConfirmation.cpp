...
//==============================================================================
DeleteInstanceConfirmation::DeleteInstanceConfirmation (String agentName)
{
    ...
    label->setText("Delete port "+agentName + " ?",dontSendNotification);
    okPressed_=false;
...
DeleteInstanceConfirmation::~DeleteInstanceConfirmation()
{
...
//==============================================================================
void DeleteInstanceConfirmation::paint (Graphics& g)
{
...
void DeleteInstanceConfirmation::resized()
{
    okButton->setBounds (200, 104, 71, 24);
    cancelButton->setBounds (112, 104, 71, 24);
...
void DeleteInstanceConfirmation::buttonClicked (Button* buttonThatWasClicked)
{
...
<JUCER_COMPONENT documentType="Component" className="DeleteInstanceConfirmation"
                 componentName="" parentClasses="public Component" constructorParams="String agentName"
  ...
  <TEXTBUTTON name="okButton" id="e2aadca74a756fb3" memberName="okButton" virtualName=""
              explicitFocusOrder="0" pos="200 104 71 24" bgColOff="ffaeaeae"
  ...
  <LABEL name="new label" id="cf632a1aa060f6f0" memberName="label" virtualName=""
         ...
         edTextCol="ff000000" edBkgCol="0" labelText=" Delete instance ?"
