...
//==============================================================================
DeleteTrunkConfirmation::DeleteTrunkConfirmation ()
{
    ...
    //[UserPreSize]
    label->setText("Delete trunk ?",dontSendNotification);
    okPressed_=false;
...
//==============================================================================
void DeleteTrunkConfirmation::paint (Graphics& g)
{
...
void DeleteTrunkConfirmation::resized()
{
...
void DeleteTrunkConfirmation::buttonClicked (Button* buttonThatWasClicked)
{
...
<JUCER_COMPONENT documentType="Component" className="DeleteTrunkConfirmation"
  ...
  <LABEL name="new label" id="cf632a1aa060f6f0" memberName="label" virtualName=""
         ...
         edTextCol="ff000000" edBkgCol="0" labelText=" Delete trunk ?"
