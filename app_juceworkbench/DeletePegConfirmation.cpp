...
//==============================================================================
DeletePegConfirmation::DeletePegConfirmation ()
{
    ...
    //[UserPreSize]
    label->setText("Delete hook ?",dontSendNotification);
    okPressed_=false;
...
//==============================================================================
void DeletePegConfirmation::paint (Graphics& g)
{
...
void DeletePegConfirmation::resized()
{
...
void DeletePegConfirmation::buttonClicked (Button* buttonThatWasClicked)
{
...
<JUCER_COMPONENT documentType="Component" className="DeletePegConfirmation" componentName=""
  ...
  <LABEL name="new label" id="cf632a1aa060f6f0" memberName="label" virtualName=""
         ...
         edTextCol="ff000000" edBkgCol="0" labelText=" Delete hook ?"
