...
{
    impl_t(pi_midi::midi_output_t *delegate_output): pic::safe_worker_t(0,10), current_(-1), delegate_(delegate_output),output_(0),virtual_output_(0),running_(false), null_device_name_(T(NULL_DEVICE))
    {
        piw::tsd_thing(this);
    }
