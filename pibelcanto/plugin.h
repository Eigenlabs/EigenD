...
struct bct_server_plug_ops_s
{
    ...
    void (*server_plug_change)(bct_server_t *, bct_entity_t, bct_data_t);
    void (*server_plug_tree)(bct_server_t *, bct_entity_t, bct_data_t);
};
...
#define bct_server_plug_change(bc,c,d)      ((bc)->plug_ops->server_plug_change)((bc),(c),(d))
#define bct_server_plug_attached(bc,fp)     ((bc)->plug_ops->server_plug_attached)((bc),(fp))
#define bct_server_plug_tree(bc,c,d)        ((bc)->plug_ops->server_plug_tree)((bc),(c),(d))
...
struct bct_client_host_ops_s
{
    ...
    int (*client_host_change)(bct_client_host_ops_t **, bct_data_t);
    ...
    int (*client_host_child_change)(bct_client_host_ops_t **, const unsigned char *, unsigned, bct_data_t);
    ...
    int (*client_host_tree)(bct_client_host_ops_t **, bct_data_t);
};
...
#define bct_client_host_change(bc,d)            ((*((bc)->host_ops))->client_host_change)((bc)->host_ops,(d))
...
#define bct_client_host_child_change(bc,o,ol,d) ((*((bc)->host_ops))->client_host_child_change)((bc)->host_ops,(o),(ol),(d))
...
#define bct_client_host_tree(bc,d)              ((*((bc)->host_ops))->client_host_tree)((bc)->host_ops,(d))
