...
namespace ejuce
{
    class EJUCE_DECLSPEC_CLASS Application: public juce::JUCEApplication
    {
        private:
            class impl_t;
        ...
        public:
            Application();
            ~Application();
            void initialise (const juce::String& commandLine,const char *user,const pic::f_string_t &,bool ck, bool rt);
            void shutdown();
