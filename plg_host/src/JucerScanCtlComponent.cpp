      ...
      cachedImage_innerBoxT_png (0)
{
    ...
    addAndMakeVisible (label = new Label (T("new label"),
                                          T("Scan your computer for new or updated plugins.  This may take a long time.")));
    ...
    textButton->setButtonText (T("Cancel"));
    ...
    textButton2->setButtonText (T("Scan"));
    ...
    toggleButton->setButtonText (T("Perform Full Scan"));
    toggleButton->addListener (this);

    addAndMakeVisible (label2 = new Label (T("new label"),
                                           T("These plugins failed last time.  Select to rescan.")));
    ...
    addAndMakeVisible (add_text_button = new TextButton (T("new button")));
    add_text_button->setButtonText (T("Add"));
    add_text_button->addListener (this);
    add_text_button->setColour (TextButton::buttonColourId, Colour (0xffaeaeae));

    addAndMakeVisible (del_text_button = new TextButton (T("new button")));
    del_text_button->setButtonText (T("Remove"));
    ...
    path_box->setName (T("new component"));
...
static const unsigned char resource_JucerScanCtlComponent_backgroundBoxB_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,15,0,0,0,15,8,6,0,0,0,59,214,149,74,0,0,0,9,112,72,89,115,0,0,11,
...
const int JucerScanCtlComponent::backgroundBoxB_pngSize = 316;

// JUCER_RESOURCE: backgroundBoxBl_png, 696, "../../app_eigend2/jucer/BackgroundBoxBL.png"
static const unsigned char resource_JucerScanCtlComponent_backgroundBoxBl_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,30,0,0,0,15,8,6,0,0,0,243,186,127,156,0,0,0,9,112,72,89,115,0,0,
...
const int JucerScanCtlComponent::backgroundBoxBl_pngSize = 696;

// JUCER_RESOURCE: backgroundBoxBr_png, 646, "../../app_eigend2/jucer/BackgroundBoxBR.png"
static const unsigned char resource_JucerScanCtlComponent_backgroundBoxBr_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,30,0,0,0,15,8,6,0,0,0,243,186,127,156,0,0,0,9,112,72,89,115,0,0,
11,19,0,0,11,19,1,0,154,156,24,0,0,0,151,116,69,88,116,67,111,109,109,101,110,116,0,99,72,82,77,32,99,104,117,110,107,108,101,110,32,51,50,32,105,103,110,111,114,101,100,58,13,65,83,67,73,73,58,32,46,
46,122,37,46,46,195,132,195,137,46,46,203,152,203,135,46,46,195,132,195,136,46,46,117,48,46,46,195,141,96,46,46,58,195,178,46,46,46,111,13,72,69,88,58,32,48,48,48,48,55,65,50,53,48,48,48,48,56,48,56,51,
...
const int JucerScanCtlComponent::backgroundBoxBr_pngSize = 646;
...
static const unsigned char resource_JucerScanCtlComponent_backgroundBoxL_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,15,0,0,0,15,8,6,0,0,0,59,214,149,74,0,0,0,9,112,72,89,115,0,0,11,
19,0,0,11,19,1,0,154,156,24,0,0,0,151,116,69,88,116,67,111,109,109,101,110,116,0,99,72,82,77,32,99,104,117,110,107,108,101,110,32,51,50,32,105,103,110,111,114,101,100,58,13,65,83,67,73,73,58,32,46,46,
122,37,46,46,195,132,195,137,46,46,203,152,203,135,46,46,195,132,195,136,46,46,117,48,46,46,195,141,96,46,46,58,195,178,46,46,46,111,13,72,69,88,58,32,48,48,48,48,55,65,50,53,48,48,48,48,56,48,56,51,48,
...
const int JucerScanCtlComponent::backgroundBoxL_pngSize = 292;

// JUCER_RESOURCE: backgroundBoxR_png, 296, "../../app_eigend2/jucer/BackgroundBoxR.png"
static const unsigned char resource_JucerScanCtlComponent_backgroundBoxR_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,15,0,0,0,15,8,6,0,0,0,59,214,149,74,0,0,0,9,112,72,89,115,0,0,11,
19,0,0,11,19,1,0,154,156,24,0,0,0,151,116,69,88,116,67,111,109,109,101,110,116,0,99,72,82,77,32,99,104,117,110,107,108,101,110,32,51,50,32,105,103,110,111,114,101,100,58,13,65,83,67,73,73,58,32,46,46,
122,37,46,46,195,132,195,137,46,46,203,152,203,135,46,46,195,132,195,136,46,46,117,48,46,46,195,141,96,46,46,58,195,178,46,46,46,111,13,72,69,88,58,32,48,48,48,48,55,65,50,53,48,48,48,48,56,48,56,51,48,
...
const int JucerScanCtlComponent::backgroundBoxR_pngSize = 296;

// JUCER_RESOURCE: backgroundBoxT_png, 279, "../../app_eigend2/jucer/BackgroundBoxT.png"
static const unsigned char resource_JucerScanCtlComponent_backgroundBoxT_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,15,0,0,0,15,8,6,0,0,0,59,214,149,74,0,0,0,9,112,72,89,115,0,0,11,
19,0,0,11,19,1,0,154,156,24,0,0,0,151,116,69,88,116,67,111,109,109,101,110,116,0,99,72,82,77,32,99,104,117,110,107,108,101,110,32,51,50,32,105,103,110,111,114,101,100,58,13,65,83,67,73,73,58,32,46,46,
122,37,46,46,195,132,195,137,46,46,203,152,203,135,46,46,195,132,195,136,46,46,117,48,46,46,195,141,96,46,46,58,195,178,46,46,46,111,13,72,69,88,58,32,48,48,48,48,55,65,50,53,48,48,48,48,56,48,56,51,48,
...
const int JucerScanCtlComponent::backgroundBoxT_pngSize = 279;

// JUCER_RESOURCE: backgroundBoxTl_png, 612, "../../app_eigend2/jucer/BackgroundBoxTL.png"
static const unsigned char resource_JucerScanCtlComponent_backgroundBoxTl_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,30,0,0,0,15,8,6,0,0,0,243,186,127,156,0,0,0,9,112,72,89,115,0,0,
11,19,0,0,11,19,1,0,154,156,24,0,0,0,151,116,69,88,116,67,111,109,109,101,110,116,0,99,72,82,77,32,99,104,117,110,107,108,101,110,32,51,50,32,105,103,110,111,114,101,100,58,13,65,83,67,73,73,58,32,46,
46,122,37,46,46,195,132,195,137,46,46,203,152,203,135,46,46,195,132,195,136,46,46,117,48,46,46,195,141,96,46,46,58,195,178,46,46,46,111,13,72,69,88,58,32,48,48,48,48,55,65,50,53,48,48,48,48,56,48,56,51,
...
const int JucerScanCtlComponent::backgroundBoxTl_pngSize = 612;

// JUCER_RESOURCE: backgroundBoxTr_png, 456, "../../app_eigend2/jucer/BackgroundBoxTR.png"
static const unsigned char resource_JucerScanCtlComponent_backgroundBoxTr_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,30,0,0,0,15,8,6,0,0,0,243,186,127,156,0,0,0,9,112,72,89,115,0,0,
11,19,0,0,11,19,1,0,154,156,24,0,0,0,151,116,69,88,116,67,111,109,109,101,110,116,0,99,72,82,77,32,99,104,117,110,107,108,101,110,32,51,50,32,105,103,110,111,114,101,100,58,13,65,83,67,73,73,58,32,46,
46,122,37,46,46,195,132,195,137,46,46,203,152,203,135,46,46,195,132,195,136,46,46,117,48,46,46,195,141,96,46,46,58,195,178,46,46,46,111,13,72,69,88,58,32,48,48,48,48,55,65,50,53,48,48,48,48,56,48,56,51,
...
const int JucerScanCtlComponent::backgroundBoxTr_pngSize = 456;
...
static const unsigned char resource_JucerScanCtlComponent_eigenD_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,146,0,0,0,60,8,6,0,0,0,141,109,227,16,0,0,0,4,115,66,73,84,8,8,8,8,124,8,
100,136,0,0,0,9,112,72,89,115,0,0,8,179,0,0,8,179,1,132,47,149,219,0,0,0,25,116,69,88,116,83,111,102,116,119,97,114,101,0,119,119,119,46,105,110,107,115,99,97,112,101,46,111,114,103,155,238,60,26,0,0,
7,234,73,68,65,84,120,156,237,156,123,140,85,197,29,199,63,187,92,132,214,133,173,44,212,168,224,11,88,132,224,3,181,42,138,154,216,136,241,17,109,131,36,106,53,77,109,107,19,219,24,181,177,73,99,26,95,
255,152,104,108,66,163,241,29,173,239,23,86,141,72,208,4,20,136,34,169,15,52,154,178,80,86,170,180,10,168,187,172,20,5,247,231,31,191,57,185,227,112,102,206,89,246,158,187,247,238,153,79,114,114,38,51,
191,51,51,119,207,247,252,230,55,115,230,108,139,136,16,25,246,140,1,250,128,194,110,118,107,81,21,71,26,138,31,161,98,42,140,40,164,114,208,14,140,45,178,129,40,164,230,103,116,14,155,177,168,152,10,
35,10,169,249,153,156,195,166,157,40,164,72,6,147,201,190,143,209,35,69,50,153,128,6,211,33,162,71,138,100,210,1,140,203,176,25,75,12,182,35,25,116,152,35,68,225,30,169,82,100,229,145,186,48,142,124,30,
169,165,200,78,68,33,53,62,35,128,111,3,229,121,61,82,161,163,79,28,218,26,159,163,8,175,21,197,24,41,146,139,233,192,148,64,121,67,196,72,81,72,141,79,167,57,124,228,245,72,49,216,46,57,157,192,246,64,
249,56,242,121,164,17,53,235,81,10,81,72,141,207,52,224,255,158,178,54,96,47,242,121,164,40,164,146,51,21,191,71,234,112,206,62,162,71,42,57,7,0,123,227,143,145,18,1,133,60,210,72,116,214,87,168,144,98,
176,221,216,36,2,26,15,236,147,82,158,199,35,37,65,246,72,224,7,53,234,215,110,68,33,53,54,211,60,233,132,68,64,161,24,200,94,63,42,108,230,22,133,212,216,116,122,210,9,201,144,214,130,127,120,179,197,
83,216,162,228,158,10,233,10,224,31,192,25,53,236,75,61,24,3,156,0,156,2,28,129,14,25,141,76,150,144,236,33,205,39,164,186,120,164,61,13,182,143,6,206,3,22,215,176,47,245,96,22,240,170,147,247,13,240,
95,224,117,224,206,148,242,161,100,131,39,157,208,225,73,219,180,123,210,53,101,79,133,180,0,245,72,239,212,176,47,245,32,249,28,103,57,250,27,198,161,79,250,169,192,5,230,248,0,184,17,120,98,40,58,232,
112,19,250,194,118,11,240,72,74,121,211,123,164,183,204,209,108,244,155,243,70,224,105,167,236,72,224,183,192,165,192,99,232,98,223,125,245,235,90,42,159,1,87,6,202,243,8,169,46,49,146,43,164,179,129,
147,208,69,176,117,192,18,96,105,202,117,71,162,195,196,50,160,59,80,255,24,83,223,4,244,135,182,3,255,6,30,78,177,29,9,204,3,142,3,38,162,158,193,231,245,126,134,110,47,253,59,42,142,153,192,89,230,188,
17,184,7,248,40,229,186,126,231,108,243,46,240,7,224,89,224,5,224,110,96,167,105,163,81,201,51,180,213,197,35,33,34,136,72,135,136,60,39,202,87,34,178,90,170,220,105,108,236,227,47,166,108,94,74,25,34,
50,75,68,94,16,145,29,178,59,139,82,236,59,173,54,183,136,200,123,38,189,83,68,174,73,177,127,223,148,207,49,237,184,108,19,145,153,41,215,157,96,202,31,240,244,59,57,230,154,190,239,18,145,9,25,182,67,
121,124,104,253,230,235,60,54,55,231,176,25,244,145,204,218,30,6,206,1,126,15,236,7,252,4,93,183,120,14,248,29,112,161,163,191,228,137,222,153,162,205,11,128,21,192,108,224,86,224,68,96,95,224,16,207,
...
const int JucerScanCtlComponent::eigenD_pngSize = 2157;
