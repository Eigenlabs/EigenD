      ...
      cachedImage_textBoxInner_png (0)
{
    ...
    addAndMakeVisible (notes_label2 = new Label (T("new label"),
                                                 T("Sample Rate:")));
    ...
    addAndMakeVisible (notes_label3 = new Label (T("new label"),
                                                 T("Buffer Size:")));
    ...
    addAndMakeVisible (ok_button = new TextButton (T("Save")));
    ok_button->setButtonText (T("Ok"));
    ok_button->addListener (this);
    ok_button->setColour (TextButton::buttonColourId, Colour (0xffaeaeae));

    addAndMakeVisible (control_button = new TextButton (T("Control")));
    control_button->setButtonText (T("Device Control Panel"));
    control_button->addListener (this);
    control_button->setColour (TextButton::buttonColourId, Colour (0xffaeaeae));

    addAndMakeVisible (chooser_device = new ComboBox (T("new combo box")));
    ...
    chooser_device->setTextWhenNoChoicesAvailable (T("(no choices)"));
    chooser_device->addListener (this);

    addAndMakeVisible (chooser_type = new ComboBox (T("new combo box")));
    ...
    chooser_type->setTextWhenNoChoicesAvailable (T("(no choices)"));
    chooser_type->addListener (this);

    addAndMakeVisible (chooser_rate = new ComboBox (T("new combo box")));
    ...
    chooser_rate->setTextWhenNoChoicesAvailable (T("(no choices)"));
    chooser_rate->addListener (this);

    addAndMakeVisible (chooser_buffer = new ComboBox (T("new combo box")));
    ...
    chooser_buffer->setTextWhenNoChoicesAvailable (T("(no choices)"));
