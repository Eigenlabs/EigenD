...
{
    addAndMakeVisible (title = new Label (L"new label",
                                          L"Dialog Title"));
    ...
    addAndMakeVisible (ok_button = new TextButton (L"new button"));
    ok_button->setButtonText (L"OK");
    ok_button->addListener (this);
    ok_button->setColour (TextButton::buttonColourId, Colour (0xffaeaeae));

    addAndMakeVisible (text = new Label (L"new label",
                                         L"label text"));
...
//==============================================================================
void ModalComponent::paint (Graphics& g)
{
...
void ModalComponent::buttonClicked (Button* buttonThatWasClicked)
{
...
<JUCER_COMPONENT documentType="Component" className="ModalComponent" componentName=""
...
static const unsigned char resource_ModalComponent_backgroundBoxT_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,15,0,0,0,15,8,6,0,0,0,59,214,149,74,0,0,0,9,112,72,89,115,0,0,11,19,0,0,
...
const char* ModalComponent::backgroundBoxT_png = (const char*) resource_ModalComponent_backgroundBoxT_png;
const int ModalComponent::backgroundBoxT_pngSize = 279;

// JUCER_RESOURCE: backgroundBoxL_png, 292, "../BackgroundBoxL.png"
static const unsigned char resource_ModalComponent_backgroundBoxL_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,15,0,0,0,15,8,6,0,0,0,59,214,149,74,0,0,0,9,112,72,89,115,0,0,11,19,0,0,
11,19,1,0,154,156,24,0,0,0,151,116,69,88,116,67,111,109,109,101,110,116,0,99,72,82,77,32,99,104,117,110,107,108,101,110,32,51,50,32,105,103,110,111,114,101,100,58,13,65,83,67,73,73,58,32,46,46,122,37,
46,46,195,132,195,137,46,46,203,152,203,135,46,46,195,132,195,136,46,46,117,48,46,46,195,141,96,46,46,58,195,178,46,46,46,111,13,72,69,88,58,32,48,48,48,48,55,65,50,53,48,48,48,48,56,48,56,51,48,48,48,
...
const char* ModalComponent::backgroundBoxL_png = (const char*) resource_ModalComponent_backgroundBoxL_png;
const int ModalComponent::backgroundBoxL_pngSize = 292;

// JUCER_RESOURCE: backgroundBoxR_png, 296, "../BackgroundBoxR.png"
static const unsigned char resource_ModalComponent_backgroundBoxR_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,15,0,0,0,15,8,6,0,0,0,59,214,149,74,0,0,0,9,112,72,89,115,0,0,11,19,0,0,
11,19,1,0,154,156,24,0,0,0,151,116,69,88,116,67,111,109,109,101,110,116,0,99,72,82,77,32,99,104,117,110,107,108,101,110,32,51,50,32,105,103,110,111,114,101,100,58,13,65,83,67,73,73,58,32,46,46,122,37,
46,46,195,132,195,137,46,46,203,152,203,135,46,46,195,132,195,136,46,46,117,48,46,46,195,141,96,46,46,58,195,178,46,46,46,111,13,72,69,88,58,32,48,48,48,48,55,65,50,53,48,48,48,48,56,48,56,51,48,48,48,
...
const char* ModalComponent::backgroundBoxR_png = (const char*) resource_ModalComponent_backgroundBoxR_png;
const int ModalComponent::backgroundBoxR_pngSize = 296;

// JUCER_RESOURCE: backgroundBoxB_png, 316, "../BackgroundBoxB.png"
static const unsigned char resource_ModalComponent_backgroundBoxB_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,15,0,0,0,15,8,6,0,0,0,59,214,149,74,0,0,0,9,112,72,89,115,0,0,11,19,0,0,
11,19,1,0,154,156,24,0,0,0,151,116,69,88,116,67,111,109,109,101,110,116,0,99,72,82,77,32,99,104,117,110,107,108,101,110,32,51,50,32,105,103,110,111,114,101,100,58,13,65,83,67,73,73,58,32,46,46,122,37,
46,46,195,132,195,137,46,46,203,152,203,135,46,46,195,132,195,136,46,46,117,48,46,46,195,141,96,46,46,58,195,178,46,46,46,111,13,72,69,88,58,32,48,48,48,48,55,65,50,53,48,48,48,48,56,48,56,51,48,48,48,
...
const char* ModalComponent::backgroundBoxB_png = (const char*) resource_ModalComponent_backgroundBoxB_png;
const int ModalComponent::backgroundBoxB_pngSize = 316;

// JUCER_RESOURCE: backgroundBoxTl_png, 612, "../BackgroundBoxTL.png"
static const unsigned char resource_ModalComponent_backgroundBoxTl_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,30,0,0,0,15,8,6,0,0,0,243,186,127,156,0,0,0,9,112,72,89,115,0,0,11,19,0,
...
const char* ModalComponent::backgroundBoxTl_png = (const char*) resource_ModalComponent_backgroundBoxTl_png;
const int ModalComponent::backgroundBoxTl_pngSize = 612;

// JUCER_RESOURCE: backgroundBoxTr_png, 456, "../BackgroundBoxTR.png"
static const unsigned char resource_ModalComponent_backgroundBoxTr_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,30,0,0,0,15,8,6,0,0,0,243,186,127,156,0,0,0,9,112,72,89,115,0,0,11,19,0,
0,11,19,1,0,154,156,24,0,0,0,151,116,69,88,116,67,111,109,109,101,110,116,0,99,72,82,77,32,99,104,117,110,107,108,101,110,32,51,50,32,105,103,110,111,114,101,100,58,13,65,83,67,73,73,58,32,46,46,122,37,
46,46,195,132,195,137,46,46,203,152,203,135,46,46,195,132,195,136,46,46,117,48,46,46,195,141,96,46,46,58,195,178,46,46,46,111,13,72,69,88,58,32,48,48,48,48,55,65,50,53,48,48,48,48,56,48,56,51,48,48,48,
...
const char* ModalComponent::backgroundBoxTr_png = (const char*) resource_ModalComponent_backgroundBoxTr_png;
const int ModalComponent::backgroundBoxTr_pngSize = 456;

// JUCER_RESOURCE: backgroundBoxBl_png, 696, "../BackgroundBoxBL.png"
static const unsigned char resource_ModalComponent_backgroundBoxBl_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,30,0,0,0,15,8,6,0,0,0,243,186,127,156,0,0,0,9,112,72,89,115,0,0,11,19,0,
0,11,19,1,0,154,156,24,0,0,0,151,116,69,88,116,67,111,109,109,101,110,116,0,99,72,82,77,32,99,104,117,110,107,108,101,110,32,51,50,32,105,103,110,111,114,101,100,58,13,65,83,67,73,73,58,32,46,46,122,37,
46,46,195,132,195,137,46,46,203,152,203,135,46,46,195,132,195,136,46,46,117,48,46,46,195,141,96,46,46,58,195,178,46,46,46,111,13,72,69,88,58,32,48,48,48,48,55,65,50,53,48,48,48,48,56,48,56,51,48,48,48,
...
const char* ModalComponent::backgroundBoxBl_png = (const char*) resource_ModalComponent_backgroundBoxBl_png;
const int ModalComponent::backgroundBoxBl_pngSize = 696;

// JUCER_RESOURCE: backgroundBoxBr_png, 646, "../BackgroundBoxBR.png"
static const unsigned char resource_ModalComponent_backgroundBoxBr_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,30,0,0,0,15,8,6,0,0,0,243,186,127,156,0,0,0,9,112,72,89,115,0,0,11,19,0,
0,11,19,1,0,154,156,24,0,0,0,151,116,69,88,116,67,111,109,109,101,110,116,0,99,72,82,77,32,99,104,117,110,107,108,101,110,32,51,50,32,105,103,110,111,114,101,100,58,13,65,83,67,73,73,58,32,46,46,122,37,
46,46,195,132,195,137,46,46,203,152,203,135,46,46,195,132,195,136,46,46,117,48,46,46,195,141,96,46,46,58,195,178,46,46,46,111,13,72,69,88,58,32,48,48,48,48,55,65,50,53,48,48,48,48,56,48,56,51,48,48,48,
...
const char* ModalComponent::backgroundBoxBr_png = (const char*) resource_ModalComponent_backgroundBoxBr_png;
const int ModalComponent::backgroundBoxBr_pngSize = 646;

// JUCER_RESOURCE: backgroundBoxInner_png, 503, "../BackgroundBoxInner.png"
static const unsigned char resource_ModalComponent_backgroundBoxInner_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,100,0,0,0,100,8,6,0,0,0,112,226,149,84,0,0,0,9,112,72,89,115,0,0,11,
...
const char* ModalComponent::backgroundBoxInner_png = (const char*) resource_ModalComponent_backgroundBoxInner_png;
const int ModalComponent::backgroundBoxInner_pngSize = 503;

// JUCER_RESOURCE: eigenD_png, 2157, "../eigenD.png"
static const unsigned char resource_ModalComponent_eigenD_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,146,0,0,0,60,8,6,0,0,0,141,109,227,16,0,0,0,4,115,66,73,84,8,8,8,8,124,8,100,136,
...
const char* ModalComponent::eigenD_png = (const char*) resource_ModalComponent_eigenD_png;
const int ModalComponent::eigenD_pngSize = 2157;
