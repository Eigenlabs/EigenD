...
SaveDialogComponent::SaveDialogComponent ()
{
    ...
    description->setColour (TextEditor::backgroundColourId, Colour (0x00363636));
    ...
    description->setText (TRANS("test text"));
    ...
    summary->setColour (TextEditor::shadowColourId, Colour (0x00000000));
    summary->setText (String());

    addAndMakeVisible (chooser_notes = new ComboBox ("new combo box"));
    chooser_notes->setEditableText (true);
    chooser_notes->setJustificationType (Justification::centredLeft);
    chooser_notes->setTextWhenNothingSelected (String());
    chooser_notes->setTextWhenNoChoicesAvailable (TRANS("(no choices)"));
    chooser_notes->addListener (this);

    addAndMakeVisible (chooser_words = new ComboBox ("new combo box"));
    chooser_words->setEditableText (true);
    chooser_words->setJustificationType (Justification::centredLeft);
    chooser_words->setTextWhenNothingSelected (String());
    chooser_words->setTextWhenNoChoicesAvailable (TRANS("(no choices)"));
    chooser_words->addListener (this);

    addAndMakeVisible (button_notes = new ToggleButton ("new toggle button"));
    button_notes->setButtonText (String());
    button_notes->setRadioGroupId (1);
    button_notes->addListener (this);

    addAndMakeVisible (button_words = new ToggleButton ("new toggle button"));
    button_words->setButtonText (String());
    button_words->setRadioGroupId (1);
    button_words->addListener (this);

    addAndMakeVisible (button_user = new ToggleButton ("new toggle button"));
    button_user->setButtonText (String());
    button_user->setRadioGroupId (1);
    button_user->addListener (this);

    addAndMakeVisible (chooser_user = new ComboBox ("new combo box"));
    chooser_user->setEditableText (false);
    chooser_user->setJustificationType (Justification::centredLeft);
    chooser_user->setTextWhenNothingSelected (String());
    chooser_user->setTextWhenNoChoicesAvailable (TRANS("(no choices)"));
    chooser_user->addListener (this);

    addAndMakeVisible (new_button = new TextButton ("new button"));
    new_button->setButtonText (TRANS("New"));
    ...
    addAndMakeVisible (words_label = new Label ("new label",
                                                TRANS("Belcanto Name as Words:")));
    words_label->setFont (Font (15.00f, Font::plain));
    ...
    words_label->setColour (TextEditor::backgroundColourId, Colour (0x00000000));
    ...
    addAndMakeVisible (error_label = new Label ("new label",
                                                TRANS("The Belcanto Name is invalid.")));
    error_label->setFont (Font (15.00f, Font::plain));
    error_label->setJustificationType (Justification::centredLeft);
    error_label->setEditable (false, false, false);
    error_label->setColour (Label::textColourId, Colours::red);
    error_label->setColour (TextEditor::textColourId, Colours::black);
    error_label->setColour (TextEditor::backgroundColourId, Colour (0x00000000));

    addAndMakeVisible (help_button = new TextButton ("new button"));
    help_button->setButtonText (TRANS("About Setups"));
    help_button->addListener (this);
    help_button->setColour (TextButton::buttonColourId, Colour (0xffaeaeae));

    addAndMakeVisible (default_button = new ToggleButton ("default button"));
    default_button->setButtonText (TRANS("Make the default setup"));
    ...
    cachedImage_textBoxTl_png_46 = ImageCache::getFromMemory (textBoxTl_png, textBoxTl_pngSize);
    cachedImage_textBoxTr_png_47 = ImageCache::getFromMemory (textBoxTr_png, textBoxTr_pngSize);
    cachedImage_textBoxBr_png_48 = ImageCache::getFromMemory (textBoxBr_png, textBoxBr_pngSize);
    cachedImage_textBoxBl_png_49 = ImageCache::getFromMemory (textBoxBl_png, textBoxBl_pngSize);
    cachedImage_textBoxL_png_50 = ImageCache::getFromMemory (textBoxL_png, textBoxL_pngSize);
    cachedImage_textBoxT_png_51 = ImageCache::getFromMemory (textBoxT_png, textBoxT_pngSize);
    cachedImage_textBoxR_png_52 = ImageCache::getFromMemory (textBoxR_png, textBoxR_pngSize);
    cachedImage_textBoxB_png_53 = ImageCache::getFromMemory (textBoxB_png, textBoxB_pngSize);
    cachedImage_textBoxInner_png_54 = ImageCache::getFromMemory (textBoxInner_png, textBoxInner_pngSize);
    cachedImage_eigenD_png_55 = ImageCache::getFromMemory (eigenD_png, eigenD_pngSize);
...
SaveDialogComponent::~SaveDialogComponent()
{
    ...
    save_button = nullptr;
    summary = nullptr;
    chooser_notes = nullptr;
    chooser_words = nullptr;
    button_notes = nullptr;
    button_words = nullptr;
    button_user = nullptr;
    chooser_user = nullptr;
    new_button = nullptr;
    user_label = nullptr;
    notes_label = nullptr;
    words_label = nullptr;
...
//==============================================================================
void SaveDialogComponent::paint (Graphics& g)
{
    ...
    g.setColour (Colours::black);
    g.setFont (Font (19.60f, Font::plain));
    g.drawText (TRANS("Save Setup"),
    ...
    g.setColour (Colours::black);
    g.drawImage (cachedImage_textBoxTl_png_46,
                 196, 406, 12, 12,
                 0, 0, cachedImage_textBoxTl_png_46.getWidth(), cachedImage_textBoxTl_png_46.getHeight());

    g.setColour (Colours::black);
    g.drawImage (cachedImage_textBoxTr_png_47,
                 getWidth() - 43, 406, 12, 12,
                 0, 0, cachedImage_textBoxTr_png_47.getWidth(), cachedImage_textBoxTr_png_47.getHeight());

    g.setColour (Colours::black);
    g.drawImage (cachedImage_textBoxBr_png_48,
                 getWidth() - 43, getHeight() - 104, 12, 12,
                 0, 0, cachedImage_textBoxBr_png_48.getWidth(), cachedImage_textBoxBr_png_48.getHeight());

    g.setColour (Colours::black);
    g.drawImage (cachedImage_textBoxBl_png_49,
                 196, getHeight() - 104, 12, 12,
                 0, 0, cachedImage_textBoxBl_png_49.getWidth(), cachedImage_textBoxBl_png_49.getHeight());

    g.setColour (Colours::black);
    g.drawImage (cachedImage_textBoxL_png_50,
                 196, 418, 12, getHeight() - 522,
                 0, 0, cachedImage_textBoxL_png_50.getWidth(), cachedImage_textBoxL_png_50.getHeight());

    g.setColour (Colours::black);
    g.drawImage (cachedImage_textBoxT_png_51,
                 208, 406, getWidth() - 251, 12,
                 0, 0, cachedImage_textBoxT_png_51.getWidth(), cachedImage_textBoxT_png_51.getHeight());

    g.setColour (Colours::black);
    g.drawImage (cachedImage_textBoxR_png_52,
                 getWidth() - 43, 418, 12, getHeight() - 522,
                 0, 0, cachedImage_textBoxR_png_52.getWidth(), cachedImage_textBoxR_png_52.getHeight());

    g.setColour (Colours::black);
    g.drawImage (cachedImage_textBoxB_png_53,
                 208, getHeight() - 104, getWidth() - 251, 12,
                 0, 0, cachedImage_textBoxB_png_53.getWidth(), cachedImage_textBoxB_png_53.getHeight());

    g.setColour (Colours::black);
    g.drawImage (cachedImage_textBoxInner_png_54,
                 208, 418, getWidth() - 251, getHeight() - 522,
                 0, 0, cachedImage_textBoxInner_png_54.getWidth(), cachedImage_textBoxInner_png_54.getHeight());

    g.setColour (Colours::black);
    g.drawImage (cachedImage_eigenD_png_55,
                 getWidth() - 177, 12, 146, 60,
                 0, 0, cachedImage_eigenD_png_55.getWidth(), cachedImage_eigenD_png_55.getHeight());
...
void SaveDialogComponent::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    else if (buttonThatWasClicked == button_notes)
    {
        //[UserButtonCode_button_notes] -- add your button handler code here..
        //[/UserButtonCode_button_notes]
    }
    else if (buttonThatWasClicked == button_words)
    {
        //[UserButtonCode_button_words] -- add your button handler code here..
        //[/UserButtonCode_button_words]
    }
    else if (buttonThatWasClicked == button_user)
    {
        //[UserButtonCode_button_user] -- add your button handler code here..
        //[/UserButtonCode_button_user]
    }
    else if (buttonThatWasClicked == new_button)
    {
        //[UserButtonCode_new_button] -- add your button handler code here..
        //[/UserButtonCode_new_button]
    }
    ...
    else if (buttonThatWasClicked == default_button)
    {
        //[UserButtonCode_default_button] -- add your button handler code here..
        //[/UserButtonCode_default_button]
    }
...
void SaveDialogComponent::comboBoxChanged (ComboBox* comboBoxThatHasChanged)
{
    //[UsercomboBoxChanged_Pre]
    //[/UsercomboBoxChanged_Pre]

    if (comboBoxThatHasChanged == chooser_notes)
    {
        //[UserComboBoxCode_chooser_notes] -- add your combo box handling code here..
        //[/UserComboBoxCode_chooser_notes]
    }
    else if (comboBoxThatHasChanged == chooser_words)
    {
        //[UserComboBoxCode_chooser_words] -- add your combo box handling code here..
        //[/UserComboBoxCode_chooser_words]
    }
    else if (comboBoxThatHasChanged == chooser_user)
    {
        //[UserComboBoxCode_chooser_user] -- add your combo box handling code here..
        //[/UserComboBoxCode_chooser_user]
    }
...
<JUCER_COMPONENT documentType="Component" className="SaveDialogComponent" componentName=""
  ...
  <BACKGROUND backgroundColour="ff000000">
    ...
    <TEXT pos="106c 123c 140 30" fill="solid: ff000000" hasStroke="0" text="Save Setup"
          fontname="Default font" fontsize="19.600000000000001421" bold="0"
...
static const unsigned char resource_SaveDialogComponent_backgroundBoxT_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,30,0,0,0,30,8,2,0,0,0,180,82,57,245,0,0,0,25,116,69,88,116,83,111,102,
...
const char* SaveDialogComponent::backgroundBoxT_png = (const char*) resource_SaveDialogComponent_backgroundBoxT_png;
const int SaveDialogComponent::backgroundBoxT_pngSize = 973;

// JUCER_RESOURCE: backgroundBoxL_png, 973, "BackgroundBoxL.png"
static const unsigned char resource_SaveDialogComponent_backgroundBoxL_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0
png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,30,0,0,0,30,8,2,0,0,0,180,82,57,245,0,0,0,25,116,69,88,116,83,111,102,
116,119,97,114,101,0,65,100,111,98,101,32,73,109,97,103,101,82,101,97,100,121,113,201,101,60,0,0,3,34,105,84,88,116,88,77,76,58,99,111,109,46,97,100,111,98,101,46,120,109,112,0,0,0,0,0,60,63,120,112,97,
99,107,101,116,32,98,101,103,105,110,61,34,239,187,191,34,32,105,100,61,34,87,53,77,48,77,112,67,101,104,105,72,122,114,101,83,122,78,84,99,122,107,99,57,100,34,63,62,32,60,120,58,120,109,112,109,101,
116,97,32,120,109,108,110,115,58,120,61,34,97,100,111,98,101,58,110,115,58,109,101,116,97,47,34,32,120,58,120,109,112,116,107,61,34,65,100,111,98,101,32,88,77,80,32,67,111,114,101,32,53,46,48,45,99,48,
54,48,32,54,49,46,49,51,52,55,55,55,44,32,50,48,49,48,47,48,50,47,49,50,45,49,55,58,51,50,58,48,48,32,32,32,32,32,32,32,32,34,62,32,60,114,100,102,58,82,68,70,32,120,109,108,110,115,58,114,100,102,61,
...
const char* SaveDialogComponent::backgroundBoxB_png = (const char*) resource_SaveDialogComponent_backgroundBoxB_png;
const int SaveDialogComponent::backgroundBoxB_pngSize = 985;

// JUCER_RESOURCE: backgroundBoxTl_png, 1501, "BackgroundBoxTL.png"
static const unsigned char resource_SaveDialogComponent_backgroundBoxTl_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,60,0,0,0,30,8,6,0,0,0,112,152,125,79,0,0,0,25,116,69,88,116,83,111,
...
const char* SaveDialogComponent::backgroundBoxTl_png = (const char*) resource_SaveDialogComponent_backgroundBoxTl_png;
const int SaveDialogComponent::backgroundBoxTl_pngSize = 1501;

// JUCER_RESOURCE: backgroundBoxTr_png, 1411, "BackgroundBoxTR.png"
static const unsigned char resource_SaveDialogComponent_backgroundBoxTr_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,60,0,0,0,30,8,6,0,0,0,112,152,125,79,0,0,0,25,116,69,88,116,83,111,
102,116,119,97,114,101,0,65,100,111,98,101,32,73,109,97,103,101,82,101,97,100,121,113,201,101,60,0,0,3,34,105,84,88,116,88,77,76,58,99,111,109,46,97,100,111,98,101,46,120,109,112,0,0,0,0,0,60,63,120,112,
97,99,107,101,116,32,98,101,103,105,110,61,34,239,187,191,34,32,105,100,61,34,87,53,77,48,77,112,67,101,104,105,72,122,114,101,83,122,78,84,99,122,107,99,57,100,34,63,62,32,60,120,58,120,109,112,109,101,
116,97,32,120,109,108,110,115,58,120,61,34,97,100,111,98,101,58,110,115,58,109,101,116,97,47,34,32,120,58,120,109,112,116,107,61,34,65,100,111,98,101,32,88,77,80,32,67,111,114,101,32,53,46,48,45,99,48,
54,48,32,54,49,46,49,51,52,55,55,55,44,32,50,48,49,48,47,48,50,47,49,50,45,49,55,58,51,50,58,48,48,32,32,32,32,32,32,32,32,34,62,32,60,114,100,102,58,82,68,70,32,120,109,108,110,115,58,114,100,102,61,
...
const char* SaveDialogComponent::backgroundBoxTr_png = (const char*) resource_SaveDialogComponent_backgroundBoxTr_png;
const int SaveDialogComponent::backgroundBoxTr_pngSize = 1411;

// JUCER_RESOURCE: backgroundBoxBl_png, 1610, "BackgroundBoxBL.png"
static const unsigned char resource_SaveDialogComponent_backgroundBoxBl_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0
png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,100,0,0,0,100,8,6,0,0,0,112,226,149,84,0,0,0,9,112,72,89,115,0,
...
const char* SaveDialogComponent::backgroundBoxInner_png = (const char*) resource_SaveDialogComponent_backgroundBoxInner_png;
const int SaveDialogComponent::backgroundBoxInner_pngSize = 503;

// JUCER_RESOURCE: textBoxTl_png, 1379, "TextBoxTL.png"
static const unsigned char resource_SaveDialogComponent_textBoxTl_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,24,0,0,0,24,8,6,0,0,0,224,119,61,248,0,0,0,25,116,69,88,116,83,111,102,116,
...
const char* SaveDialogComponent::textBoxTl_png = (const char*) resource_SaveDialogComponent_textBoxTl_png;
const int SaveDialogComponent::textBoxTl_pngSize = 1379;

// JUCER_RESOURCE: textBoxTr_png, 1408, "TextBoxTR.png"
static const unsigned char resource_SaveDialogComponent_textBoxTr_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,24,0,0,0,24,8,6,0,0,0,224,119,61,248,0,0,0,25,116,69,88,116,83,111,102,116,
119,97,114,101,0,65,100,111,98,101,32,73,109,97,103,101,82,101,97,100,121,113,201,101,60,0,0,3,34,105,84,88,116,88,77,76,58,99,111,109,46,97,100,111,98,101,46,120,109,112,0,0,0,0,0,60,63,120,112,97,99,
107,101,116,32,98,101,103,105,110,61,34,239,187,191,34,32,105,100,61,34,87,53,77,48,77,112,67,101,104,105,72,122,114,101,83,122,78,84,99,122,107,99,57,100,34,63,62,32,60,120,58,120,109,112,109,101,116,
97,32,120,109,108,110,115,58,120,61,34,97,100,111,98,101,58,110,115,58,109,101,116,97,47,34,32,120,58,120,109,112,116,107,61,34,65,100,111,98,101,32,88,77,80,32,67,111,114,101,32,53,46,48,45,99,48,54,
48,32,54,49,46,49,51,52,55,55,55,44,32,50,48,49,48,47,48,50,47,49,50,45,49,55,58,51,50,58,48,48,32,32,32,32,32,32,32,32,34,62,32,60,114,100,102,58,82,68,70,32,120,109,108,110,115,58,114,100,102,61,34,
...
const char* SaveDialogComponent::textBoxTr_png = (const char*) resource_SaveDialogComponent_textBoxTr_png;
const int SaveDialogComponent::textBoxTr_pngSize = 1408;

// JUCER_RESOURCE: textBoxBr_png, 1341, "TextBoxBR.png"
static const unsigned char resource_SaveDialogComponent_textBoxBr_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,24,0,0,0,24,8,6,0,0,0,224,119,61,248,0,0,0,25,116,69,88,116,83,111,102,116,
119,97,114,101,0,65,100,111,98,101,32,73,109,97,103,101,82,101,97,100,121,113,201,101,60,0,0,3,34,105,84,88,116,88,77,76,58,99,111,109,46,97,100,111,98,101,46,120,109,112,0,0,0,0,0,60,63,120,112,97,99,
107,101,116,32,98,101,103,105,110,61,34,239,187,191,34,32,105,100,61,34,87,53,77,48,77,112,67,101,104,105,72,122,114,101,83,122,78,84,99,122,107,99,57,100,34,63,62,32,60,120,58,120,109,112,109,101,116,
97,32,120,109,108,110,115,58,120,61,34,97,100,111,98,101,58,110,115,58,109,101,116,97,47,34,32,120,58,120,109,112,116,107,61,34,65,100,111,98,101,32,88,77,80,32,67,111,114,101,32,53,46,48,45,99,48,54,
png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,24,0,0,0,24,8,2,0,0,0,111,21,170,175,0,0,0,25,116,69,88,116,83,111,102,116,
...
const char* SaveDialogComponent::textBoxB_png = (const char*) resource_SaveDialogComponent_textBoxB_png;
const int SaveDialogComponent::textBoxB_pngSize = 1040;

// JUCER_RESOURCE: textBoxInner_png, 940, "TextBoxInner.png"
static const unsigned char resource_SaveDialogComponent_textBoxInner_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,0,20,0,0,0,20,8,2,0,0,0,2,235,138,90,0,0,0,25,116,69,88,116,83,111,102,
116,119,97,114,101,0,65,100,111,98,101,32,73,109,97,103,101,82,101,97,100,121,113,201,101,60,0,0,3,34,105,84,88,116,88,77,76,58,99,111,109,46,97,100,111,98,101,46,120,109,112,0,0,0,0,0,60,63,120,112,97,
99,107,101,116,32,98,101,103,105,110,61,34,239,187,191,34,32,105,100,61,34,87,53,77,48,77,112,67,101,104,105,72,122,114,101,83,122,78,84,99,122,107,99,57,100,34,63,62,32,60,120,58,120,109,112,109,101,
116,97,32,120,109,108,110,115,58,120,61,34,97,100,111,98,101,58,110,115,58,109,101,116,97,47,34,32,120,58,120,109,112,116,107,61,34,65,100,111,98,101,32,88,77,80,32,67,111,114,101,32,53,46,48,45,99,48,
54,48,32,54,49,46,49,51,52,55,55,55,44,32,50,48,49,48,47,48,50,47,49,50,45,49,55,58,51,50,58,48,48,32,32,32,32,32,32,32,32,34,62,32,60,114,100,102,58,82,68,70,32,120,109,108,110,115,58,114,100,102,61,
...
const char* SaveDialogComponent::textBoxInner_png = (const char*) resource_SaveDialogComponent_textBoxInner_png;
const int SaveDialogComponent::textBoxInner_pngSize = 940;

// JUCER_RESOURCE: eigenD_png, 3575, "eigenD@2x.png"
static const unsigned char resource_SaveDialogComponent_eigenD_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,1,36,0,0,0,120,8,2,0,0,0,212,160,24,131,0,0,0,25,116,69,88,116,83,111,102,116,
119,97,114,101,0,65,100,111,98,101,32,73,109,97,103,101,82,101,97,100,121,113,201,101,60,0,0,3,34,105,84,88,116,88,77,76,58,99,111,109,46,97,100,111,98,101,46,120,109,112,0,0,0,0,0,60,63,120,112,97,99,
107,101,116,32,98,101,103,105,110,61,34,239,187,191,34,32,105,100,61,34,87,53,77,48,77,112,67,101,104,105,72,122,114,101,83,122,78,84,99,122,107,99,57,100,34,63,62,32,60,120,58,120,109,112,109,101,116,
97,32,120,109,108,110,115,58,120,61,34,97,100,111,98,101,58,110,115,58,109,101,116,97,47,34,32,120,58,120,109,112,116,107,61,34,65,100,111,98,101,32,88,77,80,32,67,111,114,101,32,53,46,48,45,99,48,54,
48,32,54,49,46,49,51,52,55,55,55,44,32,50,48,49,48,47,48,50,47,49,50,45,49,55,58,51,50,58,48,48,32,32,32,32,32,32,32,32,34,62,32,60,114,100,102,58,82,68,70,32,120,109,108,110,115,58,114,100,102,61,34,
...
const char* SaveDialogComponent::eigenD_png = (const char*) resource_SaveDialogComponent_eigenD_png;
const int SaveDialogComponent::eigenD_pngSize = 3575;
