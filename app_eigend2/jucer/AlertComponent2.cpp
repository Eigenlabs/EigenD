      ...
      cachedImage_eigenD_png (0)
{
    ...
    toggleButton->setButtonText ("Don\'t show this message again");
    ...
    addAndMakeVisible (cancel_button = new TextButton ("new button"));
    cancel_button->setButtonText ("Cancel");
    cancel_button->addListener (this);
    cancel_button->setColour (TextButton::buttonColourId, Colour (0xffaeaeae));

    addAndMakeVisible (text = new Label ("new label",
                                         "label text"));
...
static const unsigned char resource_AlertComponent2_eigenD_png[] = { 137,80,78,71,13,10,26,10,0,0,0,13,73,72,68,82,0,0,1,36,0,0,0,120,8,2,0,0,0,212,160,24,131,0,0,0,25,116,69,88,116,83,111,102,
...
const int AlertComponent2::eigenD_pngSize = 3575;
