...
void midiHandler( double timeStamp, pic::lckvector_t<unsigned char>::lcktype *bytes, void *ptr )
{
...
THREAD_RETURN THREAD_TYPE socketHandler(void *ptr)
{
  Messager::MessagerData *data = (Messager::MessagerData *) ptr;
  Skini::Message message;
  pic::lckvector_t<int>::lcktype &fd = data->fd;
  ...
  std::string line;
  pic::lckvector_t<int>::lcktype fdclose;
