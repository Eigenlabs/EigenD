...
Filter :: Filter( pic::lckvector_t<StkFloat>::lcktype &bCoefficients, pic::lckvector_t<StkFloat>::lcktype &aCoefficients )
{
  // Check the arguments.
  ...
  inputs_ = pic::lckvector_t<StkFloat>::lcktype ( b_.size() );
  outputs_ = pic::lckvector_t<StkFloat>::lcktype ( a_.size() );
  this->clear();
}
...
void Filter :: setCoefficients( pic::lckvector_t<StkFloat>::lcktype &bCoefficients, pic::lckvector_t<StkFloat>::lcktype &aCoefficients, bool clearState )
{
  // Check the arguments.
  if ( bCoefficients.size() == 0 || aCoefficients.size() == 0 ) {
...
void Filter :: setNumerator( pic::lckvector_t<StkFloat>::lcktype &bCoefficients, bool clearState )
{
  // Check the argument.
...
void Filter :: setDenominator( pic::lckvector_t<StkFloat>::lcktype &aCoefficients, bool clearState )
{
  // Check the argument.
