...
public:
  ...
  */
  Filter( pic::lckvector_t<StkFloat>::lcktype &bCoefficients, pic::lckvector_t<StkFloat>::lcktype &aCoefficients );
  ...
  */
  void setCoefficients( pic::lckvector_t<StkFloat>::lcktype &bCoefficients, pic::lckvector_t<StkFloat>::lcktype &aCoefficients, bool clearState = false );
  ...
  */
  void setNumerator( pic::lckvector_t<StkFloat>::lcktype &bCoefficients, bool clearState = false );
  ...
  */
  void setDenominator( pic::lckvector_t<StkFloat>::lcktype &aCoefficients, bool clearState = false );
...
protected:
  ...
  StkFloat gain_;
  pic::lckvector_t<StkFloat>::lcktype b_;
  pic::lckvector_t<StkFloat>::lcktype a_;
  pic::lckvector_t<StkFloat>::lcktype outputs_;
  pic::lckvector_t<StkFloat>::lcktype inputs_;
