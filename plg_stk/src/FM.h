...
class FM : public Instrmnt
{
 ...
 protected:
  ...
  pic::lckvector_t<ADSR *>::lcktype adsr_; 
  pic::lckvector_t<WaveLoop *>::lcktype waves_;
  SineWave vibrato_;
  TwoZero  twozero_;
  unsigned int nOperators_;
  StkFloat baseFrequency_;
  pic::lckvector_t<StkFloat>::lcktype ratios_;
  pic::lckvector_t<StkFloat>::lcktype gains_;
  StkFloat modDepth_;
  StkFloat control1_;
  StkFloat control2_;
