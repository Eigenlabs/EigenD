...
class MidiFileIn : public Stk
{
  ...
  */
  unsigned long getNextEvent( pic::lckvector_t<unsigned char>::lcktype *event, unsigned int track = 0 );
  ...
  /*!
      ...
      StkError exception will be thrown.
  */
  unsigned long getNextMidiEvent( pic::lckvector_t<unsigned char>::lcktype *midiEvent, unsigned int track = 0 );
 ...
 protected:
  ...
  int division_;
  bool usingTimeCode_;
  pic::lckvector_t<double>::lcktype tickSeconds_;
  pic::lckvector_t<long>::lcktype trackPointers_;
  pic::lckvector_t<long>::lcktype trackOffsets_;
  pic::lckvector_t<long>::lcktype trackLengths_;
  pic::lckvector_t<char>::lcktype trackStatus_;
  ...
  pic::lckvector_t<TempoChange>::lcktype tempoEvents_;
  pic::lckvector_t<unsigned long>::lcktype trackCounters_;
  pic::lckvector_t<unsigned int>::lcktype trackTempoIndex_;
};
