...
#ifndef __TABBED_COMPONENT_2__
#define __TABBED_COMPONENT_2__
...
/**
    ...
    @see TabbedButtonBar
*/
class  TabbedComponent2  : public Component
{
public:
    //==============================================================================
    /** Creates a TabbedComponent2, specifying where the tabs should be placed.

        Once created, add some tabs with the addTab() method.
    */
    TabbedComponent2 (const TabbedButtonBar2::Orientation orientation);
    ...
    /** Changes the placement of the tabs.
        ...
        @see TabbedButtonBar2::setOrientation
    */
    void setOrientation (const TabbedButtonBar2::Orientation orientation);

    /** Returns the current tab placement.

        @see setOrientation, TabbedButtonBar2::getOrientation
    */
    TabbedButtonBar2::Orientation getOrientation() const throw();
    ...
    */
    ...
    /** Removes all the tabs from the bar.
        ...
        @see TabbedButtonBar2::clearTabs
    */
    void clearTabs();
    ...
    */
    ...
    /** Returns the content component that was added for the given index.
        ...
        with the TabbedComponent2's use of them.
    */
    ...
    /** Changes the currently-selected tab.
        ...
        @see TabbedButtonBar2::setCurrentTabIndex
    */
    void setCurrentTabIndex (const int newTabIndex, const bool sendChangeMessage = true);

    /** Returns the index of the currently selected tab.

        @see addTab, TabbedButtonBar2::getCurrentTabIndex()
    */
    int getCurrentTabIndex() const;

    /** Returns the name of the currently selected tab.

        @see addTab, TabbedButtonBar2::getCurrentTabName()
    */
    ...
    */
    TabbedButtonBar2& getTabbedButtonBar() const throw()             { return *tabs; }
...
private:
    ...
    friend class TabCompButtonBar2;
    void changeCallback (const int newCurrentTabIndex, const String& newTabName);

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (TabbedComponent2);
};


#endif   // __TABBED_COMPONENT_2__
